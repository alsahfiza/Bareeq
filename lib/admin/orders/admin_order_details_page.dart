...
class _AdminOrderDetailsPageState extends State<AdminOrderDetailsPage> {
  ...
  Widget _statusButtons(String current) {
    return Row(
      children: [
        _statusBtn("pending", "Pending", Colors.orange, current),
        const SizedBox(width: 10),
        _statusBtn("processing", "Processing", Colors.blue, current),
        const SizedBox(width: 10),
        _statusBtn("completed", "Completed", Colors.green, current),
        const SizedBox(width: 10),
        _statusBtn("cancelled", "Cancelled", Colors.red, current),
      ],
    );
  }
